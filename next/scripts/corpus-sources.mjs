...
export const TOOL_CATALOG = [
  ...
  // ── 2026-08-13: katalog 43 → 56 tamamlandı ────────────────────────────────
  // Bu 13 rota diskte vardı ama TOOL_CATALOG'ta yoktu; /sor onları hiç
  // bulamıyordu. Başlık ve açıklamalar her rotanın kendi page.js'indeki
  // TITLE_TR/EN + DESC_TR/EN sabitlerinden alındı (drift olmasın diye).
  // NOT: /arac/wow bilinçli olarak EKLENMEDİ — /arac/kurani-tani'ye 308
  // redirect eden legacy slug. /arac/tum-araclar da yok: katalog sayfasının
  // kendisi.
  { route: '/arac/ses-mimarisi', titleTr: 'Ses Mimarisi', titleEn: 'Sound Architecture', descTr: 'Azap ayetlerindeki patlayıcı ünsüzler, rahmet ayetlerindeki akıcı sesler; fonetik-semantik örtüşme.', descEn: 'Plosive consonants in verses of wrath, flowing liquids in verses of mercy; phonetic-semantic correspondence.', keywords: ['ses', 'fonetik', 'unsuz', 'akici', 'azap', 'rahmet', 'ritim'] },
  { route: '/arac/tarihsel-kanitlar', titleTr: 'Tarihsel İzler', titleEn: 'Historical Traces', descTr: 'Firavun bedeni, Hâmân ismi, Bizans-Pers kehaneti. Kur\'ân haber verir; bulgular tefekküre vesiledir.', descEn: 'The body of Pharaoh, the name Hāmān, the Byzantine-Persian prophecy. The Qur\'an informs; findings are an occasion for reflection.', keywords: ['tarih', 'firavun', 'haman', 'rum', 'arkeoloji', 'bizans'] },
  { route: '/arac/zaman-boyutlari', titleTr: 'Zaman Boyutları', titleEn: 'Dimensions of Time', descTr: 'Kur\'an\'da zaman algısı — gün, sene, devir, an; göreceli zaman ölçeği.', descEn: 'The perception of time in the Quran — day, year, epoch, instant; the relative scale of time.', keywords: ['zaman', 'gun', 'sene', 'devir', 'an', 'gorecelilik'] },
  { route: '/arac/yeminler', titleTr: 'Kur\'an\'ın Yeminleri', titleEn: 'The Oaths of the Quran', descTr: 'İncir, zeytin, andolsun, kasem — 25+ yemin ve yemin-cevap (cevâb-ı kasem) yapıları.', descEn: 'Fig, olive, oath formulas — 25+ divine oaths and their answering clauses.', keywords: ['yemin', 'kasem', 'incir', 'zeytin', 'andolsun'] },
  { route: '/arac/neden-sonuc', titleTr: 'Neden → Sonuç Atlası', titleEn: 'Cause → Effect Atlas', descTr: 'Sabır → yardım → zafer, şükür → nimet artışı, kibir → helâk: Kur\'ânî nedensellik zincirleri.', descEn: 'Patience → help → victory, gratitude → increase, arrogance → ruin: Quranic chains of causality.', keywords: ['neden', 'sonuc', 'nedensellik', 'sabir', 'sukur', 'kibir', 'helak'] },
  ...
  { route: '/arac/elestirel-cerceve', titleTr: 'Eleştirel Çerçeve', titleEn: 'Critical Frame', descTr: 'Zorlu sorulara dengeli okuma: miras eşitsizliği, kölelik, cizye, Nûh tufanı.', descEn: 'A balanced reading for hard questions: inheritance, slavery, jizya, the flood of Noah.', keywords: ['elestiri', 'zorlu-soru', 'miras', 'kolelik', 'cizye', 'tufan', 'apolojetik'] },
  { route: '/graf/kelime-isi', titleTr: 'Kelime Isı Haritası', titleEn: 'Word Heatmap', descTr: 'Bir kelimenin Kur\'an\'daki yoğunluğunu sûre-sûre ısı haritasıyla gör.', descEn: 'See the density of a word across the Quran as a surah-by-surah heatmap.', keywords: ['kelime', 'isi-haritasi', 'yogunluk', 'frekans', 'heatmap'] },
  { route: '/graf/semantik', titleTr: 'Semantik Harita', titleEn: 'Semantic Map', descTr: 'Sûrelerin semantik kümeleri — UMAP projeksiyonuyla 2D içerik akrabalığı.', descEn: 'Semantic clusters of the surahs — content kinship in 2D via UMAP projection.', keywords: ['semantik', 'umap', 'kume', 'projeksiyon', 'akrabalik'] },
  { route: '/graf/zaman', titleTr: 'Nüzul Kronolojisi', titleEn: 'Revelation Timeline', descTr: 'Mekkî/Medenî sıralama, 23 yıllık nüzul kronolojisi, sûre-bazlı zaman çizelgesi.', descEn: 'Meccan and Medinan ordering, the 23-year chronology of revelation, a surah-by-surah timeline.', keywords: ['nuzul', 'kronoloji', 'mekki', 'medeni', 'siralama', 'timeline'] },
  { route: '/graf/karsilastir', titleTr: 'Sûre Karşılaştırıcı', titleEn: 'Surah Comparator', descTr: 'İki sûreyi yan yana karşılaştır — uzunluk, dönem, ortak temalar, tekrar eden ifadeler.', descEn: 'Compare any two surahs side by side — length, period, shared themes, recurring expressions.', keywords: ['karsilastir', 'sure', 'kiyas', 'tema', 'uzunluk'] },
  { route: '/graf/diyalog', titleTr: 'Diyalog Ağı', titleEn: 'Dialogue Network', descTr: 'Kur\'an\'daki ~300 diyalog — Allah-Mûsâ, İbrâhim-baba, Yûsuf-kardeşler — 25 eksende ağ.', descEn: 'About 300 dialogues in the Quran — God-Moses, Abraham-father, Joseph-brothers — mapped across 25 axes.', keywords: ['diyalog', 'konusma', 'musa', 'ibrahim', 'yusuf', 'ag'] },
