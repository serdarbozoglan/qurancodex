      ...
      <div style={{ flex: 1, maxWidth: '1200px', width: '100%', margin: '0 auto', padding: '32px 24px 64px', boxSizing: 'border-box' }}>
        ...
        <div style={{
          ...
          <p style={{
            ...
            {tr
              ? <>Felsufi&apos;nin seçilmiş yazıları: Kur&apos;an kavramlarının kök etimolojisi, sûre tahlilleri, epistemoloji ve tasavvufî psikoloji üzerine denemeler. Her makale <strong style={{ color: COLORS.gold, fontWeight: 600 }}>Kavram Ağı</strong>, <strong style={{ color: COLORS.gold, fontWeight: 600 }}>Ayet Haritası</strong> ve <strong style={{ color: COLORS.gold, fontWeight: 600 }}>Okuma Modu</strong> ile çift yönlü bağlıdır.</>
              : <>Curated essays by Felsufi on the root etymology of Quranic concepts, surah analyses, epistemology and Sufi psychology. Each essay is bidirectionally linked to <strong style={{ color: COLORS.gold, fontWeight: 600 }}>Concept Graph</strong>, <strong style={{ color: COLORS.gold, fontWeight: 600 }}>Verse Map</strong>, and <strong style={{ color: COLORS.gold, fontWeight: 600 }}>Reading Mode</strong>.</>}
          </p>
        ...
        <div style={{
          ...
          <p style={{ margin: 0 }}>
            {tr
              ...
              : <>We thank <a href="https://sufist.medium.com" target="_blank" rel="noopener noreferrer" style={{ color: COLORS.gold, fontWeight: 600 }}>Felsufi</a> for the <strong style={{ color: COLORS.gold, fontWeight: 600 }}>verbal permission</strong> to share these selected essays. The interpretations and syntheses in them are the <strong style={{ color: COLORS.gold, fontWeight: 600 }}>author&apos;s own reflection</strong>; QuranCodex presents these texts as an <em style={{ color: COLORS.offWhite, fontStyle: 'italic' }}>invitation to think</em>. The canonical source remains on Medium or Substack and is bidirectionally linked with site tools.</>}
          </p>
        </div>
      </div>
    </div>
