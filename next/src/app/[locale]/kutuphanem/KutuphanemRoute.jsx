...
const TYPE_LABELS_TR = {
  ...
  'alan-disiplin': 'Alan sayfası',
  'dua-peygamber': 'Peygamber duası',
  'risale-not': 'Risale-i Nur notu',
  'dua-dili-katman': 'Dua dili',
  'kuran-sayi': 'Sayılar',
  'iblis-adlandirma': 'İki isim',
  'furuk-aile': 'Fürûk',
  'atlas-kavim': 'Kavim',
  'atlas-esma': 'Esma',
  'atlas-dua': 'Dua',
...
const TYPE_LABELS_EN = {
  ...
  'alan-disiplin': 'Field page',
  'dua-peygamber': 'Prophetic prayer',
  'risale-not': 'Risale-i Nur note',
  'dua-dili-katman': 'Language of prayer',
  'kuran-sayi': 'Numbers',
  'iblis-adlandirma': 'Two names',
  'furuk-aile': 'Distinctions',
  'atlas-kavim': 'Nation',
