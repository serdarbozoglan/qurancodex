...
const LAST_UPDATED_TR = '15 Eylül 2026';
const LAST_UPDATED_EN = 'September 15, 2026';
...
const SECTIONS = [
  {
    ...
    bodyTr: [
      ...
      "Amaç, akademik bilgiyi keşfedilebilir hâle getirmektir. Her araç, klasik tefsir ve modern akademik literatüre dayanarak bir örüntüyü görünür kılar; okuyanı bilgilendirmenin yanında tefekküre de davet eder.",
    ],
    bodyEn: [
      ...
      "The aim is to make scholarship explorable. Each tool makes a pattern visible on the basis of classical tafsir and modern academic literature, inviting reflection as well as information.",
    ],
  },
  {
    id: 'durus',
