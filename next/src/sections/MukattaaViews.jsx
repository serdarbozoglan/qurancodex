...
const GORUSLER = [
  ...
  },
  {
    ...
    kimTr: 'Halîl b. Ahmed ve Sîbeveyh’e nisbet edilir · Zeyd b. Eslem · Süyûtî el-İtkân’da kaydeder',
    kimEn: 'Attributed to al-Khalīl b. Aḥmad and Sībawayh · Zayd b. Aslam · catalogued by al-Suyūṭī in al-Itqān',
  ...
  },
  {
    ...
    dayanakTr: 'Altı sûrede harfleri yemin izler. Üçünde harf ile yemin AYNI âyettedir: Sâd (38:1), Kâf (50:1) ve Kalem (68:1); üçü de tek harflidir ve arkasından doğrudan bir kasem cümlesi gelir. Üçünde ise harfler kendi âyetinde durur, yemin bir sonraki âyette gelir: Yâsîn (36:1-2), Zuhruf (43:1-2) ve Duhân (44:1-2). Âyetlerin kendisi aşağıda.',
    dayanakEn: 'In six suras an oath follows the letters. In three the letter and the oath stand in the SAME verse: Ṣād 38:1, Qāf 50:1 (\"by the glorious Qurʾān\") and al-Qalam 68:1 (\"by the pen and what they write\"); each of these is a single letter followed directly by an oath clause. In three others the letters close their own verse and the oath opens the next: Yā-Sīn 36:1-2, al-Zukhruf 43:1-2 and al-Dukhān 44:1-2.',
    zayifTr: 'Ama bu altısının dışında yemin edatı yoktur: Bakara 2:1’den sonra “ذٰلِكَ الْكِتَابُ” gelir, yemin değil. Yani görüş bu altı sûrede güçlü, kalan 23’ünde dayanaksız kalır; bütünü açıklamaz.',
    zayifEn: 'Beyond those six there is no oath particle: al-Baqara 2:1 is followed by \"That is the Book\", not an oath. The view is strong for those six and unsupported in the remaining 23; it does not explain the whole.',
  },
  {
    id: 'tenbih',
    renk: '#6fc98a',
