...
// ─── RetorikSorularCard — Anasayfa tanıtıcı kart (kapı/portal) ─────
// /arac/retorik-sorular sayfasının anasayfadaki giriş kapısı.
// Derin içerik AYNI — /sections/QuranRhetoric.jsx (RetorikSorular.jsx wrapper)
...
export default function RetorikSorularCard() {
    ...
    >
      ...
      >
        ...
        <h2 style={{
          ...
          {tr ? "Bir Soru, Bin Cevap" : "One Question, a Thousand Answers"}
        </h2>
        ...
        <div style={{ marginBottom: '36px' }}>
          ...
          <p style={{
            ...
            "{tr ? "Kur'an'ı düşünüp anlamaya çalışmıyorlar mı?" : "Will they not then ponder upon the Quran?"}"
          </p>
          <p style={{
            color: COLORS.silver,
            fontFamily: FONTS.body,
        ...
        >
          <Link
            href={`/${language}/arac/retorik-sorular`}
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              gap: '12px',
          ...
          >
            <span>{tr ? "Retorik Sorular Sayfasını Keşfet" : "Explore the Rhetorical Questions Page"}</span>
