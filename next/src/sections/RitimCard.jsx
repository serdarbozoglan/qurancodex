...
// ─── RitimCard — Anasayfa tanıtıcı kart (kapı/portal) ──────────────────────
// /arac/ritim sayfasının anasayfadaki giriş kapısı.
//   - Derin içerik AYNI — /sections/ImpossibleRhythm.jsx (Ritim.jsx wrapper'da render)
//   - Pattern: MukattaaCard ile birebir uyumlu portal/CTA.
// ──────────────────────────────────────────────────────────────────────────────
...
export default function RitimCard() {
    ...
    >
      ...
      >
        <div style={{
          ...
          {tr ? 'İmkânsız Ritim' : 'Impossible Rhythm'}
        </div>
        ...
        <h2 style={{
          ...
          {tr ? 'Ne Şiir, Ne Düzyazı' : 'Neither Poetry, Nor Prose'}
        </h2>

        {/* Anchor verse — Necm 53:1 */}
        ...
        >
          ...
          >
            <span>{tr ? 'Ritim Sayfasını Keşfet' : 'Explore the Rhythm Page'}</span>
        ...
        >
          {tr
            ? '16 vezin · sui generis · 1.400 yıllık eşsizlik'
