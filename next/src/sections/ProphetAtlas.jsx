...
const PROPHETS_REF = [
  {
    ...
    giftsEn:[
      ...
      "Taught all the names; knowledge the angels did not possess (2:31-33)",
      "The angels prostrated to him; the first and only prostration in human history (2:34)",
  ...
  },
  {
    ...
    noteTr: "Kur'an'ın en az söz ettiği peygamberlerden biri; yalnızca 2 kez geçer. Her kelimesi özenle seçilmiştir.",
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "'Şükredici kul' unvanıyla anıldı; Kur'an'da çok az kişiye verilmiş bir lakap (17:3)",
    ...
    giftsEn:[
      ...
      "Called 'a grateful servant'; a title given to very few in the Quran (17:3)",
    ...
    giftsTooltipsTr:{
      ...
      4: "Sâffât 37:79: 'Selâmun alâ Nûhin fi'l-âlemîn.' Bu formülle âlemlere selam gönderilmesi Kur'an'da çok nadir bir şereftir.",
    },
    giftsTooltipsEn:{
      ...
      4: "As-Saffat 37:79: 'Peace be upon Noah among all the worlds.' A greeting sent across all the worlds is a very rare honour in the Quran.",
    },
  ...
  },
  {
    ...
    giftsEn:[
      ...
      "His people called him 'foolish' and 'liar'; the same slanders later directed at the Prophet (7:66)",
      "'I am a trustworthy messenger to you', and he asked no payment for his message (26:125-127)",
    ...
    giftsTooltipsTr:{
      ...
      4: "Ahkâf 46:24-25: Azap rüzgârını önce bulut sanan kavim, yaklaştığında gerçeği anladı. 'Her şeyi Rabbinin emriyle yerle bir eder' ifadesi Kur'an'ın en sert azap tasvirlerinden biridir.",
    },
    giftsTooltipsEn:{
      2: "Al-Araf 7:66: Their leaders said: 'We see you in foolishness and think you among the liars.' The Quran deliberately echoes this; its parallel with the accusations against the Prophet is not coincidental.",
      4: "Al-Ahqaf 46:24-25: The people first mistook the punishment for rain clouds. 'Destroying everything by the command of its Lord' is among the harshest punishment descriptions in the Quran.",
    },
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "Semud gök gürültüsüyle helak edildi; her kavmin azabı farklıdır (11:67)",
      "Semud'un izi silindi; yalnızca yurtları kaldı, bugün Mada'in Sâlih (Hegra) adıyla bilinen UNESCO alanı (7:74)",
    ],
    giftsEn:[
    ...
    giftsTooltipsTr:{
      ...
      3: "Hûd 11:65: Kur'an'ın geri sayım ultimatumu. 'X gün sonra azap' formatı peygamber kıssaları içinde başka yerde görülmez. Klasik tefsirlerde üç günün her biri için farklı bir alamet aktarılır.",
    },
    giftsTooltipsEn:{
      ...
      2: "An-Naml 27:48-49: These nine men also conspired to assassinate Salih. The Quran reveals that their plot was known before they acted.",
      3: "Hud 11:65: The Quran's countdown ultimatum. The 'punishment in X days' format appears nowhere else among the prophet narratives. Classical tafsir records a different sign for each of the three days.",
    },
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "Oğlunu kurban etmeye razı oldu; Allah bunu apaçık bir sınav olarak nitelendirdi (37:103-107)",
    ...
    giftsTooltipsTr:{
      0: "Nisâ 4:125: 'Allah İbrahim'i dost (halîl) edindi.' Halîl, dostlukta en yüksek mertebedir. Kur'an bu unvanı başka hiçbir peygambere vermez.",
      2: "Tevbe 9:114: 'İbrahim'in babası için istiğfar etmesi, yalnızca ona verdiği bir söz yüzündendi. Onun Allah'ın düşmanı olduğu açıkça belli olunca ondan uzaklaştı.' Bu istiğfar vefanın ifadesidir.",
      3: "Enbiyâ 21:62-63: 'Bunu kim yaptı?' diye sorduklarında İbrahim: 'Belki şunu yaptı, ona sorun, eğer konuşabiliyorsa.' Kendisi yaparken gördükleri hâlde cevap veremediler. Kur'an'ın en keskin hiciv sahnelerinden biri.",
    ...
    giftsTooltipsEn:{
      ...
      2: "At-Tawbah 9:114: 'Abraham's seeking forgiveness for his father was only because of a promise he had made. When it became clear that he was an enemy of Allah, he disassociated himself.' The intercession was an act of loyalty.",
      3: "Al-Anbiya 21:62-63: When asked who destroyed the idols, Ibrahim said: 'Perhaps the big one did it; ask him, if he can speak.' They had seen him do it but could not answer. One of the Quran's sharpest scenes of wit.",
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "Melekler misafir geldi; şehrin helak edileceğini ve sabaha kadar ayrılması gerektiğini bildirdi. Eşi geride kalacaktı (11:81)",
    ...
    giftsEn:[
      ...
      "Angels came as guests and told him the city would be destroyed and that he must leave before dawn. His wife would remain behind (11:81)",
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "Kurban yerine büyük bir fidye, bir koç gönderildi (37:107)",
    ...
    giftsTooltipsTr:{
      0: "Meryem 19:54: 'sâdıku'l-va'd' ifadesi Kur'an'da yalnızca bu peygamber için kullanılan bir unvandır. Hz. İsmâil'in babasına verdiği söze sadakati ve kurban anındaki teslimiyeti bu unvanın somut yansımasıdır.",
      4: "Saffât 37:102: 'Beraber teslim olduklarında...' (فَلَمَّا أَسْلَمَا). İki peygamberin aynı anda tam teslimiyeti, Kur'an'ın en dramatik sahnelerinden biridir.",
    },
    giftsTooltipsEn:{
      0: "Maryam 19:54: 'sâdiq al-wa'd' is a title the Quran applies to this prophet alone. Ishmael's faithfulness to his word to his father, and his submission at the moment of sacrifice, embody this title.",
      4: "As-Saffat 37:102: 'When they had both submitted...' (فَلَمَّا أَسْلَمَا). Two prophets in complete submission at the same moment, one of the Quran's most dramatic scenes.",
    },
  ...
  },
  {
    ...
    giftsTooltipsTr:{
      0: "Yûsuf 12:86: 'Ben derdimi ve üzüntümü ancak Allah'a arz ediyorum; Allah'tan sizin bilmediğinizi biliyorum.' Yıllar süren ayrılık ve körleşme; yine de hiç şikâyet etmedi.",
      2: "Yûsuf 12:68: Ayet 'öğrettiğimizden ötürü ilim sahibiydi' diyor. Bu, ona verilmiş ilâhî bir kavrayıştır; gaybı bilmek değil, olayların arkasındaki hikmeti görebilmek.",
    ...
    giftsTooltipsEn:{
      0: "Yusuf 12:86: 'I only complain of my suffering and my grief to Allah, and I know from Allah what you do not know.' Years of separation and blindness, yet he never complained to others.",
      ...
      4: "Yusuf 12:94: 'If you did not think me weakened in judgement, I would say I sense the smell of Joseph.' Prophetic perception: the caravan had just departed Egypt, and the news had not yet reached Canaan.",
    },
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "Zindanda bile tebliğ etti; rüya tabirini orada iki mahkûma gösterdi (12:37)",
    ...
    giftsEn:[
      "The Quran itself calls this story 'the best of stories'; a self-reference found nowhere else (12:3)",
      ...
      "Even in prison he taught; he demonstrated dream interpretation to two fellow inmates (12:37)",
    ...
    giftsTooltipsTr:{
      3: "Yûsuf 12:24: 'Eğer Rabbinin burhanını görmeseydi...' Buradaki 'burhan' (açık delil, işaret) müfessirler arasında en çok tartışılan ifadelerden biridir. Ne olduğu kesin bilinmiyor: ilâhî bir ikaz mı, aklî bir uyarı mı, vahiy mi? Ayet kesin bir tanım vermiyor.",
    },
    giftsTooltipsEn:{
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "Kavmi ona 'namazın mı seni bunları yasaklıyor?' diye sordu; dinî baskının açık ifadesi (11:87)",
    ...
    giftsEn:[
      ...
      "His people saw him as weak: 'Were it not for your clan, we would stone you.' They mistook his strength for tribal loyalty rather than faith (11:91)",
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "Firavun'a 'yumuşak söz söyleyin' emri; Hz. Hârûn ile birlikte gönderilmesinin hikmeti (20:44)",
      ...
      "Ülü'l-azm: beş büyük peygamber arasında Hz. Nuh, Hz. İbrahim ve Hz. İsa ile anıldı (33:7)",
    ],
    giftsEn:[
      ...
      "Commanded to speak to Pharaoh with 'gentle speech'; the wisdom behind sending Aaron with him (20:44)",
      ...
      "Ulu'l-azm: one of the five greatest prophets, named alongside Noah, Abraham and Jesus (33:7)",
    ],
  ...
  },
  {
    ...
    giftsTooltipsTr:{
      ...
      4: "A'râf 7:150: Hz. Musa döndüğünde levhaları fırlattı ve Hârûn'u saçından tuttu. Hârûn: 'Ey annemin oğlu! Beni saçımdan ve sakalımdan tutma. Ben senin düşmanlarını sevindirmekten korktum.' Kur'an'daki en insanî kardeş diyaloglarından biri.",
    },
    giftsTooltipsEn:{
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "'Eğer tesbih edenlerden olmasaydı kıyamete kadar kalırdı'; geçmiş ibadetinin meyvesi (37:143-144)",
      ...
      "Kavmi azap gelmeden iman etti ve kurtuldu; Kur'an'da bunun tek örneği (10:98)",
    ],
    giftsEn:[
      ...
      "'Had he not been of those who glorify Allah, he would have remained until Resurrection Day' (37:143-144)",
    ...
    giftsTooltipsTr: { 2: 'Sâffât 143-144\'teki bu ifade, Hz. Yûnus\'un önceki tesbihlerinin balığın karnında duasının kabulüne vesile olduğuna işaret eder; müfessirlerin büyük çoğunluğunun benimsediği yorum budur.' },
    giftsTooltipsEn: { 2: 'This clause in Ṣāffāt 143-144 indicates that his prior glorifications were the means by which his prayer was answered in the whale; this is the interpretation held by the majority of classical scholars.' },
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "Kavmine 'Allah'tan korkun' diyerek tebliğ etti; onları Baal'a değil, âlemlerin en güzel yaratıcısına çağırdı (37:124-125)",
      "Kavmi onu yalanladı; yalnızca seçilmiş kulları iman etti (37:127)",
      "'İl-Yâsîn'e selam olsun': âlemlerde selamla anıldı; Hz. Nuh'a verilen selamla aynı formül (37:130)",
      "Salih kullar arasında; Allah'ın tesciliyle (37:132)(6:85)",
    ],
    giftsEn:[
      "Among the Mursal: registered among the sent messengers (37:123)",
      "Called his people: 'Will you not fear Allah?' He invited them to the finest of creators, not to Baal (37:124-125)",
      "His people denied him; only Allah's chosen servants believed (37:127)",
      "'Peace upon Il-Yasin': greeted across all the worlds; the same formula as the greeting given to Noah (37:130)",
      "Among the righteous servants; by Allah's own testimony (37:132)(6:85)",
    ],
    giftsTooltipsTr:{
      3: "Saffât 37:130: 'İl-Yâsîn'e selam olsun' ifadesi klasik tefsirde tartışmalıdır. Büyük çoğunluk bunun Hz. İlyâs'ın başka bir adı veya kavminin adı olduğunu söyler. Bazı müfessirler Hz. İdrîs'i, bazıları Hz. Muhammed'in (s.a.v.) soyunu kasteder. Kur'an kesin bir açıklama yapmıyor; bu belirsizlik bilinçli olabilir.",
    },
    giftsTooltipsEn:{
      3: "As-Saffat 37:130: The phrase 'Peace upon Il-Yasin' is debated in classical tafsir. Most commentators say it is another name for Elijah or refers to his community. Some cite Idris; others link it to the Prophet's lineage. The Quran does not clarify, and this ambiguity may itself be intentional.",
    },
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "Hz. İlyâs'ın ardından gelen peygamber olduğu kabul edilir; Kur'an ikisini aynı listede zikreder ama halef ilişkisini açıkça belirtmez (38:48)",
    ],
    giftsEn:[
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "İki ayrı sûrede, iki ayrı seçkin liste içinde anılır; Kur'an'ın ona verdiği çifte tescil (21:85)(38:48)",
    ...
    giftsEn:[
      ...
      "The name 'Dhul-Kifl' means 'the one who undertakes a pledge'; the name itself is a characterization (21:85)",
    ],
    giftsTooltipsTr:{
    ...
    giftsTooltipsEn:{
      0: "The Quran does not explicitly give Dhul-Kifl the title of 'prophet' or 'messenger'; it says only that he was among the patient. His prophetic status is debated: Ibn Kathir and Tabari held he was a prophet, while others considered him a righteous servant.",
  ...
  },
  {
    ...
    giftsTooltipsTr:{
      6: "Sâd 38:17: Allah'ın 'عَبْدَنَا دَاوُودَ' (kulumuz Dâvûd) ifadesi doğrudan ilâhî bir nitelendirmedir. 'نِعْمَ الْعَبْدُ' (ne güzel kul) formülü ise aynı sûrede Hz. Süleymân (38:30) ve Hz. Eyyûb (38:44) için kullanılır. İkisi de yüksek övgüdür, ancak farklı Arapça formüllerdir.",
    },
    giftsTooltipsEn:{
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "'Rabbim! Benden sonra kimseye nasip olmayacak bir mülk bağışla'; başkasına verilmeyecek bir mülk duası (38:35)",
    ],
    giftsEn:[
      ...
      "'My Lord! Grant me a kingdom that shall not belong to anyone after me'; the prayer for a kingdom given to no one else (38:35)",
    ],
    giftsTooltipsTr:{
      7: "Sâd 38:35-38: Bu dua hemen kabul edildi; ardından rüzgâr (38:36), şeytanlar ve dalgıçlar (38:37) ve bağlı diğer güçler (38:38) emrine verildi. Kur'an bu duayı kibir olarak değil, Allah'ın ona özgü bir lütfu olarak sunar.",
    },
    giftsTooltipsEn:{
      7: "Sad 38:35-38: This prayer was immediately granted; the wind (38:36), every devil and diver (38:37), and others bound in chains (38:38) were all subjected to him. The Quran presents this not as arrogance but as a divine gift particular to him.",
    },
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "Yahya'ya daha önce kimseye verilmemiş bir isim konuldu (19:7)",
      "Gizlice seslenerek dua etti; kemikleri zayıflamış, başı ağarmıştı, yine de Allah'a yöneldi (19:3-4)",
      "Alâmet olarak, sağlıklı olduğu hâlde 3 gece insanlarla konuşamama verildi; Kur'an'da başka örneği olmayan bir ilâhî işaret (19:10)",
    ...
    giftsEn:[
      ...
      "John was given a name never used before; no one had ever been called by it (19:7)",
      "Called to his Lord in a secret voice; his bones weakened, his head filled with white, yet he turned to Allah (19:3-4)",
      "Given the sign of three nights of speechlessness while physically sound; a divine sign with no parallel in the Quran (19:10)",
  ...
  },
  {
    ...
    surahs:[3,6,19,21],
    giftsTr:[
      "Bu isimle daha önce hiç kimse adlandırılmamıştı (19:7)",
      "Hz. İsa'yı tasdik etmek üzere gönderildi; iki peygamber arasındaki nadir bir ilişki (3:39)",
    ...
    giftsEn:[
      "No one had ever been given this name before (19:7)",
      "Sent to confirm Jesus; a rare direct relationship between two prophets (3:39)",
  ...
  },
  {
    ...
    giftsTr:[
      ...
      "Babasız, yalnızca anneden doğdu; Kur'an'ın açıkça anlattığı mucizevî doğum (19:20-21)",
      ...
      "Çamurdan kuş yaptı, ölü diriltti, körleri iyileştirdi; hepsi Allah'ın izniyle (3:49)",
      "Rûhullah ve Kelimetullah: Kur'an'ın yalnızca ona verdiği iki unvan (4:171)",
    ...
    giftsEn:[
      "Announced by angels to Mary as 'a word from Allah', before his creation (3:45)",
      ...
      "His likeness before Allah is that of Adam; both fatherless, created by 'Be' (3:59)",
      "Made a bird from clay, raised the dead, healed the blind; all by Allah's permission (3:49)",
      "Ruhullah and Kalimullah: two titles the Quran gives to him alone (4:171)",
...
const PROPHETS = [
  ...
  },
  {
    ...
    surahs: [
      ...
      { s:34, phaseTr:'Rüzgâr, cinler ve vefâtı: asaya dayanma', phaseEn:'Wind, Jinn and Death: Leaning on the Staff' },
  ...
  },
  {
    ...
    surahs: [
      ...
      { s:68, phaseTr:'\'Balık sahibi\' gibi olma: Rasûl\'e öğüt', phaseEn:"Warning: Do Not Be Like the Man of the Fish" },
    ],
  },
  {
    id: 'zekeriya-yahya',
    nameTr: 'Hz. Zekeriya & Hz. Yahyâ', nameEn: 'Zechariah & John',
    subtitleTr: 'Yaşlılıkta kabul edilen dua: Meryem\'in kefili ve ona müjdelenen evlat',
    subtitleEn: 'A prayer answered in old age: the guardian of Mary and the son foretold to him',
    ...
    <section id="prophet-atlas" style={{
          ...
          <div style={{ marginBottom: '36px' }}>
            ...
            <p style={{
              ...
              {tr(
                ...
                "The prophet narratives in the Quran are not incidental; each was revealed to mirror what Prophet Muhammad (s.a.v.) was facing at that moment. Over 23 years, revelation functioned as a targeted program of guidance and support.",
              )}
            </p>
          </div>
            ...
            {[
              {
                ...
                narrativeEn: 'Revolt against idols; monotheism despite rejection by father and people. Cast into the fire.',
              ...
              },
              {
                ...
                narrativeTr: '950 yıl alay ve inkâr; hatta öz oğlu gemiyi reddetti. Yine de inşa etti, yine de davet etti. Ona da "mecnun" dediler (Kamer 54:9).',
                ...
                contextTr: 'Ebu Talib yıllarca Hz. Muhammed\'i (s.a.v.) korudu, ama iman etmeden vefat etti. En sevilen insanın imansız ölümü, Hz. Nuh\'un oğlunun dalgalarda yok olmasıyla birebir örtüşüyordu. "Mecnun" iftirası da ortaktı.',
              ...
              },
              {
                ...
                narrativeTr: 'Kuyudan hapishaneye, hapishaneden vezirliğe; her çile bir sonraki adımın kapısıydı.',
                narrativeEn: 'From well to prison, from prison to viceroy; triumph born of the deepest darkness.',
              ...
              },
              {
                ...
                narrativeTr: 'Mucizeler de yetmedi, hüccet de; kavmi yine de bölündü. Ama Allah onu ref\' ile yükseltip şereflendirdi; o da gidinceye dek Hz. Muhammed\'i (s.a.v.) müjdeledi (Saf 61:6). Her zahirî son, ilâhî bir yeniden başlangıçtı.',
                narrativeEn: "Miracles were not enough, argument was not enough; his people divided anyway. Yet God honored him with the rafa', and before departing he foretold Prophet Muhammad (As-Saff 61:6). Every apparent ending was a divine new beginning.",
                contextTr: '631: Necran\'dan gelen Hristiyan heyeti Medine\'ye ulaştı; Âl-i İmrân\'ın büyük bölümü bu müzakereye cevap olarak indi. Mübahele ayeti (3:61), hakikatin ilan edildiği o tarihî an. Hz. Muhammed\'in (s.a.v.) zahirî "yalnızlığı" da Hz. İsa\'nın ref\'i gibi geçici bir görüntüydü.',
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px 24px 48px', width: '100%' }}>
        <CrossToolCTA
          language={language}
          links={[
            { href: `/${language}/atlas/kissa`, titleTr: 'Kıssa Atlası', titleEn: 'Story Atlas', descTr: '12 peygamberin sahne sahne kıssa anlatısı: bağlam, ders, ayet.', descEn: 'Scene-by-scene stories of 12 prophets: context, lessons, verses.' },
            { href: `/${language}/atlas/kavim`, titleTr: 'Kavimler Atlası', titleEn: 'Nations Atlas', descTr: 'Peygamberlerin gönderildiği kavimler: coğrafya ve akıbet.', descEn: 'The nations the prophets were sent to: geography and outcome.' },
            { href: `/${language}/graf/diyalog`, titleTr: 'Diyalog Ağı', titleEn: 'Dialogue Network', descTr: 'Peygamber ile muhatap arasındaki konuşma ağı: kim kime ne dedi.', descEn: 'The dialogue network between prophet and addressee: who said what to whom.' },
          ]}
        />
        <SourcesCitation
          language={language}
          sources={[
            {
              ...
              noteTr: '25 peygamberin klasik kıssa derlemesi; ayet, hadis ve selef rivayetleri birlikte.',
            ...
            },
            {
              ...
              noteEn: 'The biography of Prophet Muhammad; the foundational text connecting Quranic prophet narratives with sīra.',
            },
            {
              author: 'es-Süyûtî',
