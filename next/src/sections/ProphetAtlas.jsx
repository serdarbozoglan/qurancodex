...
const PROPHETS_REF = [
  ...
  },
  {
    ...
    giftsTooltipsTr: { 2: 'Sâffât 143-144\'teki bu ifade, Hz. Yûnus\'un önceki tesbihlerinin balığın karnında duasının kabulüne vesile olduğuna işaret eder — müfessirlerin büyük çoğunluğunun benimsediği yorum.' },
    giftsTooltipsEn: { 2: 'This clause in Ṣāffāt 143-144 indicates that his prior glorifications were the means by which his prayer was answered in the whale — the interpretation held by the majority of classical scholars.' },
