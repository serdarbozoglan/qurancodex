...
// ─── TarihselCard — Anasayfa tanıtıcı kart (kapı/portal) ─────
// /arac/tarihsel-kanitlar sayfasının anasayfadaki giriş kapısı.
// Derin içerik AYNI — /sections/HistoricalProof.jsx (TarihselKanitlar.jsx wrapper)
...
export default function TarihselCard() {
    ...
    >
      ...
      >
        <div style={{
          ...
          {tr ? "Tarihsel İzler" : "Historical Traces"}
        </div>
        ...
        >
          <Link
            href={`/${language}/arac/tarihsel-kanitlar`}
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              gap: '12px',
