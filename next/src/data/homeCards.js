...
export const HOME_CARDS = [
  ...
  },
  {
    ...
    blurb:       { tr: 'Firavun\'un bedeninin ibret için korunacağı (Yûnus 10:92) — 1881\'de Maspero yönetimindeki ekibin Deir el-Bahari keşfiyle modern literatürde daha görünür hâle gelen kraliyet mumyaları. Hâmân, Kur\'an\'da Firavun\'un çevresinden biri olarak anılır. Rûm 30:2-4 Bizans\'ın yenilgisinin ardından galip geleceğini önceden bildirir — birkaç yıl içinde gerçekleşti.', en: 'The preservation of Pharaoh\'s body as a lesson (Yūnus 10:92) — the royal mummies that became more visible in modern literature through the 1881 Deir el-Bahari excavation led by Maspero\'s team. Hāmān is mentioned in the Quran as one of Pharaoh\'s circle. Ar-Rūm 30:2-4 foretells a Byzantine victory after their defeat — fulfilled within a few years.' },
