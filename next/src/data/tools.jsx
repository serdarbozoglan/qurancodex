...
export const VIZ_TOOLS = [
  ...
  },
  {
    ...
    descTr:      '72 mesel · 8 imge evreni',
    descEn:      '72 parables · 8 imagery domains',
    descLongTr:  "Kur'an 72 mesel kullanır — sinek, örümcek, ağaç, ışık, ateş, su. Her mesel bir gerçeği somutlaştırır. 8 imge evrenine ayrılmış, çift meseller ve nûr-zulumât ekseni dahil. Hangi meselin hangi sûrede, hangi bağlamda geçtiğini keşfet.",
    descLongEn:  "The Quran uses 72 parables — fly, spider, tree, light, fire, water. Each parable makes a truth tangible. Organized into 8 imagery domains, including paired parables and the light-darkness axis. Discover which parable appears in which surah and in what context.",
    icon:        MeselIcon,
  },
  {
    id:          'kiraat-atlas',
