...
export const FEATURED_TOOL = {
  ...
  descTr:      'Az bilinen, kaynaklı gerçekler',
  descEn:      'Little-known, sourced facts',
  descLongTr:  "Kur'an hakkında az bilinen, kaynaklı gerçekler. Sayılar, dilbilim, tarih ve bilim; her biri bir ayet veya araştırmaya dayalı.",
  descLongEn:  'Little-known, sourced facts about the Quran. Numbers, linguistics, history, science; each one anchored to a verse or a study.',
  icon:        StarIcon,
};
...
export const FEATURED_TOOL_ESMA = {
  ...
  descLongEn:  'How does God describe Himself in the Quran, through which names, attributes and direct statements? 114 names and attributes · Jalāl ↔ Jamāl balance · anatomies of Āyat al-Kursī, Ḥashr 22-24 and Sūrat al-Ikhlāṣ · frequency map · direct divine self-statements.',
  icon:        EsmaIcon,
};
...
export const ANALYSIS_TOOLS = [
  ...
  },
  {
    ...
    descTr:      '50 sayı · altı grup · 56 kaynak',
    descEn:      '50 numbers · six groups · 56 sources',
...
export const RESEARCH_TOOLS = [
  ...
  },
  {
    ...
    descLongTr:  "Vâhidî, Buhârî, Süyûtî geleneğinden 30 önemli nüzul vakası: ilk vahiy, Kevser, Duhâ (fetret), İfk hadisesi, Kıble değişimi, Zeyneb bint Cahş evliliği, Hudeybiye Fetih, Vedâ Haccı Mâide 5:3 vb. Her vaka bağlam, katılımcılar, ayet referansları ve klasik kaynakla birlikte.",
  ...
  },
  {
    ...
    descEn:      'The narrative map across 23 years',
