...
export const PASSAGES = [
  ...
  },
  {
    ...
    teaserTr: 'salsāl + hamaʾ masnūn: kupkuru çamur, şekillendirilmiş kara balçık. Madde tarifinin tek ayrıntılı geçişi.',
    ...
    nuanceTr: 'İblis "ben üstünüm" demez; sadece "secde etmem" der. Üstünlük argümanı yerine yaratılış maddesinin tarifi öne çıkar. İblis\'in reddi Allah\'ın tarifini aynen tekrar eder; Yaratıcı\'nın sözünü kendi itirazına dönüştürür.',
    nuanceEn: 'Iblis does not claim "I am better"; only "I will not prostrate." Instead of a superiority argument, the description of creation matter foregrounds. Iblis\'s refusal mirrors Allah\'s own wording; it turns the Creator\'s phrasing into the grounds for refusal.',
    chips: [
  ...
  },
  {
    ...
    nuanceTr: 'iḥtinâk fiili yalnız bu sûrede geçer (17:62). Hedef artık tek bir insan değil, kuşaklar boyu süren bir soy. Ayrıca İsrâ sûresinde Allah, İblis\'e "sesinle şaşırt, süvarilerinle ve yayalarınla saldır, mallarına ve evlatlarına ortak ol" (17:64) der; askerî ve ekonomik imgeler diğer altı sûrede yoktur.',
  ...
  },
  {
    ...
    nuanceTr: 'Yedi anlatımın en sıkıştırılmışı. Diyalog yok, gerekçe yok, akıbet yok. Bütün olay tek bir fiilin, ebā (diretti) fiilinin etrafında toplanır. Bakara 2:34 bu fiile "büyüklendi ve kâfirlerden oldu" eklerken Tâ-Hâ reddin kendisinde durur. Kur\'an\'ın anlatı sıkıştırmasının uç örneklerinden biridir.',
