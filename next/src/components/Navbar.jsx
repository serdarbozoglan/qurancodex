...
const ZamanBoyutlari   = lazy(() => import('./ToolStub'));
const KuranYeminleri   = lazy(() => import('./ToolStub'));
const DogaAtlasi       = lazy(() => import('./ToolStub'));
const KavimlerAtlasi   = lazy(() => import('./ToolStub'));
const CennetCehennem   = lazy(() => import('./ToolStub'));
const KuranRetorigi    = lazy(() => import('./ToolStub'));
const Melekler         = lazy(() => import('./ToolStub'));
const KuranRenkleri    = lazy(() => import('./ToolStub'));
const KiyametSahneleri = lazy(() => import('./ToolStub'));
const KiraatAtlasi  = lazy(() => import('./ToolStub'));
const DiyalogAgi    = lazy(() => import('./ToolStub'));
const MeselAtlasi   = lazy(() => import('./ToolStub'));
const SebebiNuzul   = lazy(() => import('./ToolStub'));
const FurukAtlasi   = lazy(() => import('./ToolStub'));
const MunasebatAtlasi = lazy(() => import('./ToolStub'));
const SunnetullahAtlasi = lazy(() => import('./ToolStub'));
const MunafikProfili    = lazy(() => import('./ToolStub'));
const NefisMertebeleri  = lazy(() => import('./ToolStub'));
const IblisSatan        = lazy(() => import('./ToolStub'));
const KadinlarAtlasi    = lazy(() => import('./ToolStub'));
const IlkSonKelimeler   = lazy(() => import('./ToolStub'));
