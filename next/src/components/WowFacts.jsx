...
const FACTS = [
  ...
  },
  {
    ...
    bodyTr: 'Kehf sûresi, mağara ashâbının 300 yıl uyuduğunu söyler, ardından "ya da 309" ekler (Kehf 18:25). Klasik tefsirin çoğunluğu \'300… ya da 309\' ifadesini takvim dönüşümü değil, insanların bu süre hakkındaki ihtilafının aktarımı olarak okur. Bir çağdaş okuma ise güneş↔kamer yılı farkına işaret eder (300 güneş yılı ≈ 309 kamer yılı).',
    bodyEn: 'Surah Al-Kahf says the cave dwellers slept 300 years, then adds "or 309" (Al-Kahf 18:25). Most classical exegetes read \'300… or 309\' not as a calendar conversion but as a report of people\'s differing views on the duration. A contemporary reading points to the solar–lunar year difference (300 solar ≈ 309 lunar years).',
    wowTr: 'Süre üzerindeki ihtilaf ayetin kendisinde aktarılır.',
    wowEn: 'The verse itself records the differing views on the number.',
    explore: 'kehf',
    visualType: 'counter',
    visualData: {
      value: 309,
