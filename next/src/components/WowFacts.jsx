...
const FACTS = [
...

  {
    ...
    bodyTr: 'Kur\'an\'ın en çok geçen kelimesi, Allah lafzıdır. Sûrelerin tamamına, ayetlerin geneline yayılmıştır; hiçbir sayfa sessiz kalmaz.\n\nNot: "Allah" lafzı (özel isim formu) Quranic Arabic Corpus\'a göre 2.699 kez geçer (corpus.quran.com); "ilâh" ve "Allahümme" gibi aynı kökten formlar ayrı sayılır.',
    bodyEn: 'The most frequent word in the Quran is the name Allah itself. Spread across every surah, throughout the verses; no page is silent.\n\nNote: The name "Allah" (the proper-noun form) occurs 2,699 times per the Quranic Arabic Corpus (corpus.quran.com); related forms from the same root such as "ilah" and "Allahumma" are counted separately.',
  ...
  },
  {
    ...
    bodyEn: 'The Quran names a select group of prophets according to general scholarly consensus. Islamic tradition holds that 124,000 prophets were sent in total. Each named prophet carries a distinct lesson: patience, justice, repentance, trust... Note: The prophethood of some figures, notably Dhul-Kifl, is debated in classical exegesis.',
...

  {
    ...
    bodyTr: 'Er-Rahman sûresinde "Febieyyi âlâi Rabbikümâ tükezzibân" (Rabbinizin hangi nimetlerini yalanlıyorsunuz?) ayeti bir nakarat gibi yinelenir. Kur\'an\'ın en çok tekrar eden ayetidir. Her tekrar farklı bir nimet sayıldıktan sonra gelir, retorik bir mühür gibi.',
  ...
  },
  {
    ...
    bodyEn: 'The Quran contains 14 prostration verses; whoever recites or hears them is expected to prostrate. The fiqh classification varies by madhhab: in the Hanafi school all 14 are wajib (obligatory); in the Shafi\'i, Maliki and Hanbali schools they are generally held as sunnah (recommended). Surah Al-Hajj contains two; it is the only surah with a double prostration.',
  ...
  },
  {
    ...
    titleTr: 'Fâtiha\'da Beş İlâhî İsim',
    titleEn: 'Five Divine Names in Al-Fatiha',
    bodyTr: 'Kur\'an\'ın açılış sûresi Fâtiha, yedi âyette Allah\'ı hem adıyla hem sıfatlarıyla anar. Lafza-i celâl "Allah", Besmele\'de (Bismillâh) ve ikinci âyette (el-hamdü lillâh) geçer. Yanında dört ilâhî isim daha yer alır: Rabb (terbiye eden ve rızık veren), Rahmân (çok merhametli), Rahîm (daima merhamet eden) ve Mâlik (hesap gününün sahibi).\n\nNot: Hafs kıraatinde "Mâlik", bazı kıraatlerde "Melik" okunur.',
    bodyEn: 'Al-Fatiha, the opening surah, names God by both His name and His attributes across its seven verses. The divine name "Allah" appears in the Basmala (Bismillah) and in the second verse (al-hamdu lillah). Four more divine names appear alongside it: Rabb (Lord and Sustainer), Ar-Rahman (the All-Merciful), Ar-Rahim (the Ever-Merciful) and Malik (Master of the Day of Judgment).\n\nNote: Hafs reads "Mālik" (Master); some other readings read it as "Malik" (King).',
    wowTr: 'Yedi kısa âyette beş ilâhî isim.',
    wowEn: 'Five divine names in seven short verses.',
    explore: 'fatiha',
  },
  {
    category: 'yapisal',
  ...
  },
  {
    category: 'yapisal',
    surahRef: '29 sûre',
    titleTr: 'Huruf-i Mukattaâ: 1.400 Yıllık Soru',
    titleEn: 'Muqatta\'at Letters: A 1,400-Year Question',
    bodyTr: '29 sûre gizemli harflerle başlar: Elif-Lâm-Mîm, Hâ-Mîm, Yâ-Sîn... Bu harflerin mânâsını insanlardan hiçbiri kesin olarak tespit edebilmiş değildir. 1.400 yıldır çözülemeyen tek şifre.',
    bodyEn: '29 surahs open with mysterious letters: Alif-Lam-Mim, Ha-Mim, Ya-Sin... No human has been able to establish with certainty what they mean. A cipher unsolved for 1,400 years.',
  ...
  },
  {
    ...
    bodyTr: 'Raymond Farrin\'in araştırması pek çok sûrenin ring composition (halka) yapısına sahip olduğunu göstermektedir: A-B-C-Merkez-C\'-B\'-A\'. Fatiha bunun en yalın örneğidir. Bu yapı antik edebiyatta da bilinir; Kur\'an\'da ayırt edici olan yoğunluğu ve tutarlılığıdır.',
    bodyEn: 'Raymond Farrin\'s research shows that many surahs follow a ring composition structure: A-B-C-Center-C\'-B\'-A\'. Al-Fatiha is its simplest example. This structure also exists in ancient literature; what sets the Quran apart is its density and consistency.',
    wowTr: 'Yapısal bir örüntü.',
    wowEn: 'A structural pattern.',
    explore: '1:1',
  },

  {
    ...
    bodyTr: 'Günde 5 vakit namaz, her rekatta Fatiha okunur. Yaklaşık iki milyar Müslümanın günde beş vakit tekrarladığı bu sûre, her gün milyarlarca kez okunur. Saat dilimleri nedeniyle dünyanın her saatinde bir yerde namaz vakti girer; Fatiha\'nın okunmadığı bir an yoktur.',
    bodyEn: 'Five daily prayers, Al-Fatiha recited in every rakat. Repeated in the five daily prayers by roughly two billion Muslims, it is recited billions of times every single day. Because of time zones, prayer time is always entering somewhere in the world; there is no moment when Al-Fatiha is not being recited.',
    wowTr: 'En çok okunan metinlerden biri; her gün, her kıtada.',
    wowEn: 'One of the most recited texts; every day, on every continent.',
    explore: '1:1',
    visualType: 'counter',
    visualData: {
      value: 40,
  ...
  },
  {
    ...
    bodyTr: 'Müzzemmil sûresi (73:4): "Kur\'an\'ı tertil üzere oku." Kur\'an, kendi okunuş biçimini bizzat metni içinde emreder. Bu ayet, tecvid ilminin Kur\'anî temelidir.',
    bodyEn: 'Al-Muzzammil (73:4): "Recite the Quran with measured recitation." The Quran commands its own manner of recitation within the text itself. This verse is the Quranic foundation of the science of tajweed.',
  ...
  },
  {
    category: 'yapisal',
    surahRef: 'Et-Tevbe · 9',
    titleTr: 'Et-Tevbe: Neden Besmelesiz?',
    titleEn: 'At-Tawbah: Why No Bismillah?',
  ...
  },
  {
    ...
    bodyEn: 'Surahs are not ordered by length (general trend, many exceptions), chronology (Al-Alaq, the first revealed, is 96th in the mushaf), or alphabet. Islamic scholars hold that the order was divinely determined (tawqifi). Modern researchers continue to uncover thematic groupings and inter-surah connections.',
    wowTr: 'Sıralama insan mantığına uymayan bir düzene sahip; yine de her inceleme yeni bir bağlantı ortaya çıkarıyor.',
  ...
  },
  {
    ...
    wowTr: '950 yıl: ayetin, kavmi arasında kalma süresi olarak verdiği rakam.',
    wowEn: '950 years: the figure the verse gives for his time among his people.',
    explore: 'nuh',
    visualType: 'counter',
    visualData: {
      value: 950,
  ...
  },
  {
    ...
    bodyTr: 'Hz. Meryem Kur\'an\'da adıyla 34 kez (32 ayette) anılır ve adını taşıyan bir sûre vardır. İncil\'deki bazı havariler (Bartholomew, Thaddaeus) neredeyse hiç anılmıyor. İslam\'ın kutsal kitabında bir kadın, Hristiyan geleneğin bazı erkek azizlerinden daha fazla yer buluyor.',
    bodyEn: 'Mary is mentioned by name 34 times (across 32 verses) in the Quran and has an entire surah named after her. Some apostles in the Bible (Bartholomew, Thaddaeus) are barely mentioned. In Islam\'s scripture, a woman holds more space than some male saints of Christian tradition.',
  ...
  },
  {
    ...
    wowTr: '300 güneş yılı kamerî takvimde yaklaşık 309 yıla denk gelir; ayetteki "üç yüz ve dokuz"un bir okuması.',
  ...
  },
  {
    ...
    titleTr: '"Parmak Uçları" ve Kişiye Özgü Kimlik',
    titleEn: '"Fingertips" and Individual Identity',
    bodyTr: '"Parmak uçlarını bile yeniden düzeltmeye kadiriz" (Kıyâme 75:4). Tüm organlar arasında neden özellikle parmak uçları? 1880\'lerde belgelendi: Her insanın parmak izi kendine özgüdür, ikizlerde bile.\n\nNot: Klasik tefsirde bu ayet, kıyamette Allah\'ın yeniden yaratma gücünü anlatır; parmak uçları küçüklük ve inceliğin sembolü olarak kullanılır. Parmak izi benzersizliği bağlantısı çağdaş bir okumadır.',
    bodyEn: '"We are able to restore even his fingertips" (Al-Qiyama 75:4). Of all body parts, why specifically fingertips? Documented in the 1880s: every person\'s fingerprint is their own, even in identical twins.\n\nNote: In classical commentary, this verse describes God\'s power to resurrect; fingertips are used as a symbol of intricacy and smallness. The fingerprint uniqueness connection is a contemporary reading.',
  ...
  },
  {
    ...
    bodyTr: 'Kur\'an, "Rahman" ismini öyle bir merkeze aldı ki bu isim hem dile hem teolojiye kalıcı biçimde yerleşti. Tevbe dışında her sûrenin başındaki besmelede, Fatiha\'da ve Rahman sûresinin tamamında; bu isim Kur\'an\'ın dokusuna işlendi.',
    bodyEn: 'The Quran placed "Rahman" so centrally that it became permanently embedded in both language and theology. In the basmala at the start of every surah except At-Tawba, in Al-Fatiha and throughout Surah Ar-Rahman; this name was woven into the fabric of the Quran.',
  ...
  // ── KUR'ÂN'IN KENDİ İSİMLERİ (her biri için derinlik kartı) ─────────────────
  {
    ...
    wowEn: 'The Qur\'an\'s first self-name is not "knowledge" but "way".',
    explore: 'hüden',
  },
  {
    category: 'azBilinen',
  ...
  },
  {
    ...
    wowEn: 'The Qur\'an by its own name: "light". Not a metaphor but an ontological claim.',
    explore: '24:35',
  },
  {
    category: 'azBilinen',
    ...
    bodyTr: 'İsrâ 17:82: "Biz, Kur\'ân\'dan öyle bir şey indiriyoruz ki o, müminler için şifa ve rahmettir; zalimlerin ise yalnızca ziyanını artırır." Klasik tefsir (Kurtubî, Râzî) bu şifayı iki katmanda okur: ruhî ve ahlâkî katmanda şüphe, gurur, kibir, cimrilik gibi iç hastalıkların iyileşmesi; bedensel katmanda rukye bağlamında bazı hastalıklarda şifa vesilesi olma. Ama dikkat: klasik ulema "Kur\'ân her derde ilaçtır" genelleştirmesine mesafelidir; birinci katman kesin, ikincisi özel bağlamlıdır. Ayetin devamı sınırı çizer: "zâlimler için zararını artırır"; aynı metin aynı anda şifa da olabilir, artırıcı da.',
    ...
    <>
      ...
      >
        ...
        <section className="mq-box qc-hero-bg" style={{
          ...
          <div className="mq-fs" dir="rtl" lang="ar" aria-label="Bismillāh" style={{ fontFamily: FONTS.bismillah, '--fs-d': '2.6rem', '--fs-m': '2.2rem', color: COLORS.gold, opacity: 0.82, lineHeight: 1.2, marginBottom: '24px', textShadow: `0 0 22px ${COLORS.gold}28` }}>﷽</div>
          <p className="qc-verse-breathe" dir="rtl" lang="ar" style={{ fontFamily: FONTS.quran, fontSize: 'clamp(1.7rem, 4.2vw, 2.6rem)', color: COLORS.gold, lineHeight: 2.1, margin: '0 auto 12px', maxWidth: '780px', }}>
        ...
        >
          ...
          <div style={{ maxWidth: 1200, margin: '48px auto 0', padding: '0 4px' }}>
            <CrossToolCTA
              ...
              isMobile={isMobile}
              links={[
                { href: `/${language}/arac/kurani-tani`, titleTr: 'Kur\'an\'ı Tanı', titleEn: 'Discover the Quran', descTr: '50 gerçek: Kur\'an\'ın yapısı, mimarisi, dili ve içeriği.', descEn: '50 facts: the Quran\'s structure, architecture, language and content.' },
              ...
              sources={[
                {
                  ...
                  noteTr: "Kur'ân ilimlerinin klasik ansiklopedisi; sayısal örüntüler, dil özellikleri ve retorik incelikler için temel başvuru.",
                  noteEn: 'Classical encyclopedia of Quranic sciences; the foundational reference for numerical patterns, linguistic features and rhetorical subtleties.',
                },
                {
                  author: 'ez-Zerkeşî',
