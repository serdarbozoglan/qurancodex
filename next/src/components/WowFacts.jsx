...
const FACTS = [
  ...
  },
  {
    ...
    bodyTr: 'Allah lafzından sonra Kur\'an\'da en çok geçen Allah\'ın güzel ismi "Rahman" (Çok Merhametli); yaklaşık 57 kez. Bir sûre adını Rahman\'dan alır (Er-Rahman, 55. sûre) ve onun açılışında üst üste "Rabbinizin hangi nimetlerini yalanlıyorsunuz" sorusu tekrarlanır. Merhamet sıfatı anlatı boyunca tekrar tekrar duyulur.\n\nNot: Sayım Esma-ül Hüsna\'dan Allah\'ın özel isimleri arasındaki tek tek geçişleri kapsar; "Rab" (الرَّبّ) gibi sıfat-isimler ayrı sayılmaktadır.',
    bodyEn: 'After "Allah", the most-frequent of God\'s beautiful names is "Ar-Rahman" (The All-Merciful); approximately 57 times. One surah is named after Him (Ar-Rahman, the 55th), opening with the recurring refrain "Which of your Lord\'s favors will you deny?". The attribute of mercy recurs throughout the narrative.\n\nNote: The count covers occurrences of the personal divine name; attribute-names like "Rab" (Lord) are tallied separately.',
