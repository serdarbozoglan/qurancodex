...
const FACTS = [
  // ── SAYISAL ──────────────────────────────────────────────────────────────────
  {
    ...
    bodyTr: 'Sûrelerin neredeyse tamamı besmele ile açılır — yalnız Tevbe sûresi istisnadır. Bir kez daha Neml 27:30\'da, Hz. Süleyman\'ın Belkıs\'a yazdığı mektubun açılışı olarak geçer. Toplam sayı sûre sayısıyla denk düşer. (Not: Neml 27:30 alıntı formundadır, kur\'ânî bir sûre açılışı değildir; yine de sayısal denge dikkat çekicidir.)',
    bodyEn: 'Bismillah opens nearly every surah — At-Tawbah is the only exception. It appears once more inside An-Naml 27:30, as the opening of Solomon\'s letter to the Queen of Sheba. The total matches the surah count. (Note: An-Naml 27:30 is in quotation form, not a Quranic surah opening itself; yet the numerical balance is notable.)',
    ...
    <>
      ...
      >
        ...
        <section style={{
          ...
          <p dir="rtl" lang="ar" style={{ fontFamily: "'KFGQPC', 'Amiri Quran', serif", fontSize: 'clamp(1.15rem, 2.2vw, 1.6rem)', color: COLORS.gold, lineHeight: 2.1, margin: '0 auto 14px', maxWidth: '780px', textShadow: `0 0 20px ${COLORS.gold}1c` }}>
