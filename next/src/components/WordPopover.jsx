    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          >
            corpus.quran.com
            <ExternalLinkIcon size={11} strokeWidth={2.5} />
          </a>
        </div>
