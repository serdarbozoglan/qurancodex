...
const CONTRAST_PAIRS = [
  {
    ...
    right: {
      ...
      letters: ['ه', 'ا', 'ل', 'د'],
      descTr: 'Aynı emir kalıbı (قُلْ), ama takip eden sesler: soluklu ه, açık ا, akıcı ل, tek darbe د: tevhidin sessiz sadeliği.',
      descEn: 'The same imperative frame (قُلْ), but the following sounds: breathy ه, open ا, liquid ل, single stop د: the quiet simplicity of oneness.',
    },
...
const PHONETIC_SPECTRUM = [
  ...
  { groupTr: 'Diş-Dil (esneviyye)', groupEn: 'Dental-Lingual (asnawiyya)', letters: ['ث','ذ','ظ','ص','ض','ز','س','ت','د','ط','ن','ل','ر'], color: COLORS.royalGold, descTr: 'Diş ve dil ucu birlikte üreten sesler; en kalabalık grup.', descEn: 'Sounds produced with teeth and tongue-tip together; the most populous group.' },
  { groupTr: 'Emphatikler (musta\'liyye)', groupEn: 'Emphatics (mustaʿliyya)', letters: ['ص','ض','ط','ظ','ق','غ','خ'], color: COLORS.gold, descTr: 'Ağzı yükseltirken çıkan "koyu" sesler; azap ayetlerinde yoğunlaşır.', descEn: '"Heavy" sounds produced with a raised palate; they cluster in punishment verses.' },
];
