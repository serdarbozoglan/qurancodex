...
const PHONETIC_SPECTRUM = [
  ...
  { groupTr: 'Nazaller — Kendinden Ğunneli', groupEn: 'Nasals — Inherently Ghunna', letters: ['م','ن'], color: '#3498db', descTr: 'Burun boşluğunda rezonans; rahmet, huzur, yakarış ile eşleşir. Not: Tecvidde sükûnlu nun\'dan sonra ي ve و geldiğinde de idğâm-ı bi-ğunne kuralıyla ğunne oluşur — ancak ي, و kendi başlarına nazal değil, yarı-ünlüdür (aşağıdaki grup).', descEn: 'Resonance in the nasal cavity; pairs with mercy, peace, invocation. Note: In tajwīd, when ي or و follows a sukūn-nūn, idghām-bi-ghunna produces ghunna — yet ي, و themselves are not nasal but semi-vowels (group below).' },
