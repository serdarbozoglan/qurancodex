  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div dir="rtl" lang="ar" aria-label="Bismillāh" style={{ fontFamily: FONTS.bismillah, fontSize: '1.6rem', color: gold, opacity: 0.82, lineHeight: 1, marginBottom: '22px', textShadow: `0 0 22px ${gold}28` }}>﷽</div>
        <p dir="rtl" lang="ar" style={{ fontFamily: FONTS.quran, fontSize: 'clamp(1.2rem, 2.2vw, 1.45rem)', color: gold, lineHeight: 2.1, margin: '0 auto 14px', maxWidth: '780px', textShadow: `0 0 20px ${gold}1c` }}>
