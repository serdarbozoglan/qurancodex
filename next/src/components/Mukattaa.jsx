      ...
      <div className="mq-box" style={{ '--pt-d': "0", '--pt-m': "0", '--pr-d': "32px", '--pr-m': "16px", '--pb-d': "56px", '--pb-m': "40px", '--pl-d': "32px", '--pl-m': "16px", maxWidth: '1200px', margin: '0 auto' }}>
        <SourcesCitation
          ...
          sources={[
            ...
            { author: 'Bâkıllânî',    workTr: "İʿcâzü'l-Kur'ân",              workEn: 'Iʿjāz al-Qurʾān',             period: '950–1013 (Basra)',       noteTr: '14 harfin elifbânın yarısı olduğu ve mahreç sınıflarını temsil ettiği gözlemi; sayfadaki fâsıla ölçümünün klasik zemini.', noteEn: 'The observation that the 14 letters are half the alphabet and represent its articulatory classes; the classical ground for the rhyme measurement on this page.' },
          ]}
        />
