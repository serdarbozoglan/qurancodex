      ...
      <div className="mq-box" style={{ '--pt-d': "0", '--pt-m': "0", '--pr-d': "32px", '--pr-m': "16px", '--pb-d': "56px", '--pb-m': "40px", '--pl-d': "32px", '--pl-m': "16px", maxWidth: '1200px', margin: '0 auto' }}>
        <SourcesCitation
          ...
          sources={[
            ...
            { author: 'İbn Âşûr',     workTr: "et-Tahrîr ve't-Tenvîr",        workEn: 'al-Taḥrīr wa al-Tanwīr',      period: '1879–1973 (Tunus)',      noteTr: 'Görüşleri sistematik tasnif eder ve i\'câz/tehaddî yönünü öne çıkarır. Harflerin KELİME olarak değil harf ADIYLA okunduğu uyarısı — sayfadaki okunuş bölümünün dayanağı — ona aittir.', noteEn: 'Classifies the views systematically and favours the iʿjāz/challenge reading. The observation that the letters are read by their NAMES rather than as a word — the basis of the reading section here — is his.' },
