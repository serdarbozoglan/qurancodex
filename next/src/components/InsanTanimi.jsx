...
// ─── InsanTanimi — Tool sayfası WRAPPER ────────────────────
// Anasayfa HumanDefinition section AYNEN render; ToolHeader + Hero ekstrası.
...
export default function InsanTanimi({ onClose }) {
  ...
  return (
    <div style={{
      ...
      <ToolHeader
        icon={
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={COLORS.gold} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 21v-2a6 6 0 0 1 6-6h4a6 6 0 0 1 6 6v2"/></svg>
        }
        titleTr="Kur'an'da İnsan — Sizi Nasıl Görüyor?"
        titleEn="Humanity in the Quran — How Does It See You?"
        subtitleTr="Nefs · fıtrat · halife · imtihan · hilkat"
        subtitleEn="Nafs · fiṭra · khalīfa · trial · creation"
        language={language}
        onClose={onClose}
      />
      ...
      {/* Anasayfa HumanDefinition section AYNEN */}
      <HumanDefinition />
    </div>
  );
}
