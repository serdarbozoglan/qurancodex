...
const FACTS = [
  ...
  },
  {
    ...
    bodyTr: '"Rahman" ismi Kur\'an öncesi Arap şiirinde son derece nadir kullanılıyordu; Allah için neredeyse hiç kullanılmıyordu. Kur\'an bu ismi merkeze alarak hem dile hem teolojiye kalıcı biçimde yerleştirdi. ℹ Kelime Yemen kitabelerinde farklı bağlamlarda geçmektedir; bu nedenle "Kur\'an yarattı" değil, "Kur\'an yeniden tanımladı" ifadesi daha doğrudur.',
    bodyEn: 'The name "Rahman" was extremely rare in pre-Quranic Arabic poetry, and virtually never used for God. The Quran placed it at the center, embedding it permanently in both language and theology. ℹ The word appears in pre-Islamic South Arabian inscriptions in different contexts; hence "the Quran redefined it" is more accurate than "created it."',
  ...
  },
  {
    ...
    bodyTr: 'Arabistan\'da inen bir kitap olmasına rağmen Kur\'an coğrafi detaylara odaklanmaz. "Deve" Arapçada 6 farklı sözcükle ifade edilebilir — Kur\'an bunları çok sınırlı kullanır. Kum, çöl, oasis gibi dönem Arabistanı\'nın olmazsa olmazları arka planda kalır; evrensel kavramlar öne çıkar. ℹ "Çöl kelimesi hiç geçmez" iddiası doğrulanmayı gerektirmektedir; Arapçada çöl kavramı birden fazla kelimeyle karşılanır.',
    bodyEn: 'Despite being revealed in Arabia, the Quran does not dwell on geographical detail. "Camel" can be expressed in 6 Arabic words — the Quran uses them sparingly. Sand, oasis, and other Arabian staples fade into the background; universal concepts take center stage. ℹ The claim "desert never appears" requires verification, as the Arabic concept of desert is covered by multiple words.',
