...
const FACTS = [
  // ── SAYISAL ──────────────────────────────────────────────────────────────────
  {
    ...
    bodyTr: 'Kur\'an\'da 114 sûre vardır. Besmele 113 sûrenin başında geçer, bir kez de Neml 27:30\'da ayet içinde. Toplam: tam 114.',
  ...
  },
  {
    ...
    bodyTr: 'Kur\'an\'da 14 ayet secde emri içerir; bu ayetleri okuyan ya da duyan kişinin secde etmesi sünnet ya da vacibtir. Bunların 4\'ü vacip, 10\'u sünnet secde olarak değerlendirilir. Sûre Hac\'da iki adet secde ayeti bulunur — bu onu diğer tüm sûrelerden ayıran tek özelliktir.',
  ...
  // ── YAPISAL ──────────────────────────────────────────────────────────────────
  {
    ...
    bodyTr: 'Et-Tevbe, Kur\'an\'ın tek besmelesiz sûresidir. Bunun yerine En-Neml\'de (27:30) iki besmele geçer. Toplam besmele sayısı yine 114 eder.',
  ...
  },
  {
    ...
    bodyTr: 'Şems sûresi 11 art arda yemin ile açılır: güneşe, aydınlığına, aya, gündüze, geceye, gökyüzüne, yere ve insanın ruhuna. Her yemin bir sonrakini inşa eder; kozmostan başlayıp insana iner. 8. yeminle ani bir kırılma: "Nefse ve onu şekillendirene yemin ederim." Kur\'an\'ın başka hiçbir sûresinde bu yoğunlukta art arda yemin yoktur.',
  ...
  },
  {
    ...
    bodyTr: 'Hz. İsa Kur\'an\'da 25 kez adıyla geçer, Hz. Muhammed ise "Muhammed" olarak 4 kez, "Ahmed" olarak 1 kez — toplamda 5 doğrudan isim atfı.',
    bodyEn: 'Jesus (Isa) is mentioned by name 25 times in the Quran; Muhammad appears 4 times as "Muhammad" and once as "Ahmad" (61:6) — 5 direct name references in total.',
  ...
  },
  {
    ...
    bodyTr: 'Kehf sûresi, mağara ashâbının 300 yıl uyuduğunu söyler, ardından "ya da 309" ekler (Kehf 18:25). 300 güneş yılı = tam 309 ay yılı. Kur\'an, iki takvimi aynı anda hesaplar.',
    bodyEn: 'Surah Al-Kahf says the cave dwellers slept 300 years, then adds "or 309" (Al-Kahf 18:25). 300 solar years = exactly 309 lunar years. The Quran calculates both calendars simultaneously.',
  ...
  },
  {
    ...
    bodyTr: 'Hucurât sûresi 18 ayette şunları ele alır: ırkçılığın yasaklanması, dedikodu, lakap takma, zan, kardeşlik. 7. yüzyılda yazılan, 21. yüzyılda okunması gereken bir medeniyet programı.',
  ...
  },
  {
    ...
    bodyTr: '"Duhân" (duman/gaz bulutu, Fussilet 41:11) modern kozmolojide nebula ile örtüşüyor. "Zerre" (atom boyutunda birim) modern fizik terminolojisini önceden işaret ediyor. "Ufuk" kavramı, görelilik teorisinin sınır tanımıyla uyumlu.',
