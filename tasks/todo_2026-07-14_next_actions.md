...
- **#189 Ahiret Yolculuğu Atlası — MVP** — `/atlas/ahiret-yolculugu` live; 11 aşama · 46 ayet · §13.15 normalize · cinematic hero · dikey timeline · expandable stages · 6 CriticalNote · 6 klasik kaynak · Râzî+Kurtubî+İbn Kesîr+Gazâlî+İbn Kayyim+Suyûtî (2026-07-15). ⚠ **Faz 2 (world-class visual polish)** + **Faz 3 (qc-content-auditor + qc-visual-director pass)** kalan
